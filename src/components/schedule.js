            ...
            <div className="days-block">
                <div className="container-fluid">
                    ...
                    <div className="day2">
                        ...
                        <img className='day-img-left' src={Day2} alt=""></img>
                    ...
                    <div className="day3">
                        ...
                        <img className='day-img-right' src={Day3} alt=""></img>
                    ...
                    <div className="day4">
                        ...
                        <img className='day-img-left' src={Day4} alt=""></img>
                    ...
                    <div className="day5">
                        ...
                        <img className='day-img-right' src={Day5} alt=""></img>
                    ...
                    <div className="day6">
                        ...
                        <img className='day-img-left' src={Day6} alt=""></img>
