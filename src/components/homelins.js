        ...
        <div className='cards-wrapper'>
            ...
            <CardGroup className='cards'>
                <Card className='card-block'>
                    <Card.Img variant="top" src={Karl} id='Karl' alt="Card image"/>
                    <Card.Body>
                ...
                <Card className='card-block'>
                    <Card.Img variant="top" src={Marta} id='Marta' alt="Card image"/>
                    <Card.Body>
                ...
                <Card className='card-block'>
                    <Card.Img variant="top" src={Leo} id='Leo' alt="Card image"/>
                    <Card.Body>
                ...
                <Card className='card-block'>
                    <Card.Img variant="top" src={Varvara} id='Varvara' alt="Card image"/>
                    <Card.Body>
                ...
                <Card className='card-block'>
                    <Card.Img variant="top" src={Vitya} id='Vitya' alt="Card image"/>
                    <Card.Body>
                ...
                <Card className='card-block'>
                    <Card.Img variant="top" src={Ulya} id='Ulya' alt="Card image"/>
                    <Card.Body>
                ...
                <Card className='card-block'>
                    <Card.Img variant="top" src={Antoshka} id='Antoshka' alt="Card image"/>
                    <Card.Body>
