        ...
        <div className="day2-wrapper">
            ...
            <div>
                <Card className="bg-dark text-white top-card">
                    <Card.Img className="top-card-img" src={Center} alt=""/>
                    <Card.ImgOverlay>
                        ...
                        над зеленью которого поднимается краснокирпичный собор с витражами. Здесь же хранится прах философа Иммануила Канта.<br/>
                    ...
                    <Accordion.Item eventKey="0">
                        ...
                        <Accordion.Body>
                            ...
                            <Card className='accordion-card'>
                                <Card.Img className='card1-img' variant="top" src={Island1} alt=""/>
                                <Card.Body>
                                <Card.Text>
                            ...
                            <Card className='accordion-card'>
                                <Card.Img className='card1-img' variant="top" src={Island2} alt=""/>
                                <Card.Body>
                                <Card.Text>
                            ...
                            <Card className='accordion-card'>
                                <Card.Img className='card1-img' variant="top" src={Island3} alt=""/>
                                <Card.Body>
                                <Card.Text>
                ...
                <Card className='card1'>
                    <Card.Img className='card1-img' variant="top" src={Sobor} alt=""/>
                    <Card.Body>
                    <Card.Text>
                ...
                <Card className='card1'>
                    <Card.Img className='card1-img' variant="top" src={Kant} alt=""/>
                    <Card.Body>
                    <Card.Text>
                ...
                <Card className='card1'>
                    <Card.Img className='card1-img' variant="top" src={Village} alt=""/>
                    <Card.Body>
                    <Card.Text>
                ...
                <div className='d1-block' id='day2sec4'>
                    ...
                    <Card className='card1'>
                        <Card.Img className='card1-img' variant="top" src={Alchem} alt=""/>
                        <Card.Body>
                        <Card.Text>
                    ...
                    <Card className='card1'>
                        <Card.Img className='card1-img' variant="top" src={Pirat} alt=""/>
                        <Card.Body>
                        <Card.Text>
                    ...
                    <Card className='card1'>
                        <Card.Img className='card1-img' variant="top" src={Dk} alt=""/>
                        <Card.Body>
                        <Card.Text>
