        ...
        <div className="day3-wrapper">
            ...
            <div>
                    ...
                    <Accordion.Item eventKey="0">
                        ...
                        <Accordion.Body>
                            ...
                            <Card className='accordion-card'>
                                <Card.Img className='card1-img' variant="top" src={History} />
                                <Card.Body>
                                <Card.Text>
                            ...
                            <Card className='accordion-card'>
                                <Card.Img className='card1-img' variant="top" src={History1} />
                                <Card.Body>
                                <Card.Text>
                ...
                <Card className='card1'>
                    <Card.Img className='card1-img' variant="top" src={Fort5} />
                    <Card.Body>
                    <Card.Text>
                ...
                <Card className='card1'>
                    <Card.Img className='card1-img' variant="top" src={Zoo} />
                    <Card.Body>
                    <Card.Text>
                ...
                <Card className='card1'>
                    <Card.Img className='card1-img' variant="top" src={Vrangel} />
                    <Card.Body>
                ...
                <Card className='card1'>
                    <Card.Img className='card1-img' variant="top" src={Prud1} />
                    <Card.Body>
                ...
                <Card className='card1'>
                    <Card.Img className='card1-img' variant="top" src={Dona} />
                    <Card.Body>
                ...
                <div className='d1-block' id='day3sec4'>
                    ...
                    <Card className='card1'>
                        <Card.Img className='card1-img' variant="top" src={Brecel} />
                        <Card.Body>
                        <Card.Text>
                    ...
                    <Card className='card1'>
                        <Card.Img className='card1-img' variant="top" src={Vtarelke} />
                        <Card.Body>
                        <Card.Text>
